...
- Runtime still has 1,870 tracked `@ts-expect-error` suppressions across:
...
- `src/popup.ts` is down to 318 tracked suppressions after typing the
  ...
  and the preview command result guards.

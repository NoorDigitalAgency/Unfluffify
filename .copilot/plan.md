...
same-document navigation preservation), and Phase 3.1 (F7 Save Session bounded
retries with terminal failure/no-draft-loss behavior) are complete and
validated; continue with Phase 3.2 (F6 test-count stabilization).

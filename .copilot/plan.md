...
(F3 → F2 → F1) and Phase 2 (F4 async reconcile abort coverage → F5 dirty
same-document navigation preservation) are complete and validated; continue
with Phase 3 (F7 Save Session bounded retries → F6 test-count stabilization).

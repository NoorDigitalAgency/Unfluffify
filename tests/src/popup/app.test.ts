...
describe("popup App surface", () => {
  ...
  it("exposes the marking control ids the live QA and orchestration scripts drive", () => {
    ...
    expect(markup).toContain("Hold Ctrl to widen to an eligible ancestor");
    expect(markup).toContain("Hold Alt to explicitly include the individual target");
    expect(markup).toContain("Alt wins over Ctrl");
    expect(markup).toContain("Shift and Meta do not change marking");
